...
<body>
            ...
            <nav id="gnav">
                <div class="navbar" >
                    ...
                    <div class="menu">
                        ...
                        <a class="gsitem gsitem2 active" href="LA.php">Local-Attractions</a>
    ...
    <!-- BreadCrumb Section Start -->
     <div class="bread">
       <ul class="breadcrumbs">
          ...
          <li><a href="LA.php" class="active" >Local-Attractions</a></li>
          <!-- translate -->
        <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
        </ul>
     </div>
    <!-- BreadCrumb Section End -->
    <!-- LA information start -->
    <section class="LA">
      <h2 class="gwscheader gfocus-in-expand">Local-Attractions</h2>
      <p class="gwspara">Here are some of the local attractions in and around our area.</p>
        ...
        if ($count==0) {
          echo "<p class= 'Noinfo'>There are no informations of Local Attractions right now.Please Try again later!</p>";
        }
        else {
          for ($i=0; $i < $count ; $i+=2 )//row 
          { 
            $query1 = "SELECT LA_Names, LA_ImgURL1,LA_ImgDescription1,LA_ImgURL2,LA_ImgDescription2,LA_ImgURL3,LA_ImgDescription3 FROM Pitch ORDER BY PitchID LIMIT $i,2";

            $ret1 = mysqli_query($connect, $query1);
            $count1 = mysqli_num_rows($ret1);
            echo "<div class='lacolumn'>";
                for ($j=0; $j < $count1 ; $j++)//column
                {
                  ...
                  ?>
                  <fieldset class="la-container">
                    <legend class="des"><?php echo $LA_Names ?></legend>
                    
                      <img class="fimg" src="<?php echo $LAImg1 ?>" alt="LA" >
                      <br>
                      <p class="des2"><?php echo $LAimg1Des ?></p>
                      <b class="divider">---------<i class="fa-brands fa-canadian-maple-leaf"></i>---------</b>
                      <img class="fimg" src="<?php echo $LAImg2 ?>" alt="LA" >
                      <br>
                      <p class="des2"><?php echo $LAimg2Des ?></p>
                      <b class="divider">---------<i class="fa-brands fa-canadian-maple-leaf"></i>---------</b>
                      <img  class="fimg"src="<?php echo $LAImg3 ?>" alt="LA" >
                      <br>
                      <p class="des2"><?php echo $LAimg3Des ?></p>
    ...
    <footer class="footer">
        <div class="footer-top">
            ...
            <p>You are here at the <span>Local-Attractions</span> Page</p>
